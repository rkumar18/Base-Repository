...
// exports.insertAdminInDatabase = insertAdminInDatabase;
...
// function insertAdminInDatabase(apiContext, insertData, collection) {
//     return new Promise((resolve) => {
//         Promise.coroutine(function* () {
...
//                 email: insertData.email,
//                 password: insertData.password,
//                 countryCode: insertData.country_code,
//                 phone: insertData.phone,
...
//                 adminId: insertData.adminId,
//                 country: insertData.country,
//                 updated_at: new Date()
//             }
//             const insertResult = yield mongoLib.insertOne(apiContext, collection, insertObject);
//             if (insertResult && insertResult.insertedCount){
//                 return insertObject;
//             }
//             return false;
...
// function updateAdminDetails(apiContext, requestCriteria, updateRequest) {
//     return new Promise((resolve) => {
//         Promise.coroutine(function* () {
//             const criteria = {}
//             if (requestCriteria.admin_id) {
//                 criteria._id = requestCriteria.admin_id;
//             }
//             const updateResult = yield mongoLib.updateOne(apiContext, constants.COLLECTION_NAME.ADMIN, criteria, updateRequest);
//             return updateResult;
//         })()
//             .then((data) => {
//                 resolve(data);
...
// function checkUniqueEmail(apiContext, checkOptions, collection) {
//     return new Promise((resolve) => {
//         Promise.coroutine(function* () {
...
//             }
//             const result = yield mongoLib.findOne(apiContext, collection , criteria);
